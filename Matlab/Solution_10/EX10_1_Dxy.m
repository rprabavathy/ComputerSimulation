...
figure;
mesh(X);
title({'Substance X(x,t)', 'Constant Concentration of substance A=2 , B=5.1', 'Diffusion Constant D_X=0.001 D_Y=0.005'});
figure;
mesh(Y);
title({'Substance Y(x,t)', 'Constant Concentration of substance A=2 , B=5.1', ['Diffusion Constant D_X=0.001 D_Y=0.001']});
