...
figure;
mesh(X);
title({'Substance X(x,t)', 'Constant Concentration of substance A=2 , B=4', 'Diffusion Constant D_X=D_Y = 0.001'});
figure;
mesh(Y);
title({'Substance Y(x,t)', 'Constant Concentration of substance A=2 , B=4', 'Diffusion Constant D_X=D_Y = 0.001'});
